...
router.get('/leave/accept/:id', (req, res) => {
  ...
  const sql_3 =
    'select * from leave_requests lr join leave_types l on lr.leave_type_id = l.leave_type_id  where employee_id in (?) and approved = 0';
