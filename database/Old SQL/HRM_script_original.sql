...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HRM`.`custom_fields` ;

CREATE TABLE IF NOT EXISTS `HRM`.`custom_fields` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `HRM`.`custom_field_values` ;

CREATE TABLE IF NOT EXISTS `HRM`.`custom_field_values` (
  ...
  CONSTRAINT `fk_custom_field_values_custom_fields`
    ...
    REFERENCES `HRM`.`custom_fields` (`custom_field_id`)
    ON DELETE NO ACTION
    ON UPDATE CASCADE,
